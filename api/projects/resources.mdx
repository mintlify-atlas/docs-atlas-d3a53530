...
<ResponseField name="data" type="object">
  ...
  <Expandable title="project">
    ...
    <ResponseField name="cardinal_point" type="string">
      Cardinal direction
    </ResponseField>
  ...
  <Expandable title="work_orders">
    <ResponseField name="work_orders" type="array">
      Array of work orders (SheetProject) with nested details
    </ResponseField>
    <ResponseField name="work_orders_count" type="integer">
      Total number of work orders
    </ResponseField>
    
    Each work order includes:
    - Basic information (series_code, issue_date, period_start, period_end, status)
    - Financial data (subtotal, tax_amount, total)
    - Service details (service_type, total_gallons, total_barrels, total_cubic_meters)
    - Sheet details array with resource items and costs
    - Custody chains array with complete chain information
    - Maintenance sheets count
    - Metadata (created_at, updated_at, user info)
  </Expandable>
  
  <ResponseField name="total_custody_chains" type="integer">
